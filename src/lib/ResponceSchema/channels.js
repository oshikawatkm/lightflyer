...
function addChannel(channel) {
  ...
  channelRes.funding_txid_bytes = channel.funding_txid_bytes;
  channelRes.funding_txid_str = channel.funding_txid_str;
  channelRes.output_index = channel.output_index;
